...
| Процесс | /tmp/.hidden_malware/ | listener.sh (PID 8067, 8117) и nc (PID 8068) на порту 4444 |
...
|-------|----------------------|-----------|
| Процессы | ps aux | Дерево процессов backdoor.sh (PID 8058), listener.sh (PID 8067, 8117) и nc (PID 8068), функционирующих из каталога /tmp. |
